                    ...
                    <div class="panel-heading">
                        <asp:Panel ID="titlePanel" runat="server">
                            ...
                            <span id="panel-title" class="panel-title">
                                <span class="glyphicon glyphicon-map-marker"></span><span class="place-title"><asp:HyperLink ID="hlViewOverview" runat="server"></asp:HyperLink></span>&nbsp;is looking for a lift from&nbsp;<span class="place-title"><%#Eval("frm_place") %></span> &nbsp;to&nbsp;<span class="place-title"><%#Eval("to_place")%></span><br /><span class="glyphicon glyphicon-calendar"></span><span class="date-time"><%#((System.DateTime)Eval("date_time")).ToString("dd-MMM-yyyy HH:mm") %></span></span>          
