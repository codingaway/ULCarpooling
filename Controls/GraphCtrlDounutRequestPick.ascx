...
<asp:Chart ID="Chart1" runat="server" Height="400px" Width="450px" BorderlineWidth="1" BorderlineColor="Crimson" Palette="EarthTones">
            <Titles>
                <asp:Title Text="Top Pick Up Points Analysis in Requesting" />
            </Titles>
            <Series>
                <asp:Series Name="PickUpRequesting" ChartArea="ChartArea1">
                </asp:Series>
            </Series>
            <ChartAreas>
